...
def dump_response(nfc_binary_file,id_byte):
 ...
 nfc_data=f.read()
 f.close()
 l3_data=l3_message([0x02,0x05,id_byte,0x00,0x00,0x00,0x01,0x01,0x02,0x00,0x07]+map(ord,nfc_data[0:7])+[0x00,0x00,0x00,0x00,0x04,0x04, 0x02,0x01,0x00,0x11,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 0x03,0x00,0x39,0x3A,0x73,0x74,0x86,0x00,0x00]+map(ord, nfc_data)+[0x00]*420+AMIIBO_SIG+[0x00])
 return l3_data
